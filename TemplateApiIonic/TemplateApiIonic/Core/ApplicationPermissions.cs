...
namespace TemplateApiIonic.Core
{
    public static class ApplicationPermissions
    {
        ...
        public const string RequestPermissionGroupName = "Request Permissions";
        public static ApplicationPermission ViewRequest = new ApplicationPermission("View Request", "solicitud.view", RequestPermissionGroupName, "Permission to request available request");
        public static ApplicationPermission ManageRequest = new ApplicationPermission("Manage Request", "solicitud.manage", RequestPermissionGroupName, "Permission to create, delete and modify request");
